...
## 原版openwrt编译方法（x86）在ubuntu 22.04 ，Debian 11：
### 0.安装依赖
不同的系统请参考[openwrt wiki](https://openwrt.org/docs/guide-developer/toolchain/install-buildsystem)
```bash
sudo apt update -y
...
[Sagit 的 Packages 库](https://github.com/Sagit-chu/packages)
